    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SistemaVendasWebContext>(options =>
                    options.UseMySql(Configuration.GetConnectionString("SistemaVendasWebContext"), builder =>
builder.MigrationsAssembly("SistemaVendasWeb")));

            _ = services.AddScoped<SeedingService>();
            _ = services.AddScoped<SellerService>();
            _ = services.AddScoped<DepartmentService>();
            _ = services.AddScoped<SalesRecordService>();
        }
